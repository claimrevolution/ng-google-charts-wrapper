...
export class BarChartComponent implements OnInit, OnChanges {
  ...
  constructor(
    ...
    this.chartId = `bar_chart_${BarChartComponent.idCounter++}`;
  }
  ...
  private drawChart() {
    ...
    if (typeof google !== 'undefined' && google.visualization) {
      ...
      const chart = new google.visualization.BarChart(document.getElementById(this.chartId));
